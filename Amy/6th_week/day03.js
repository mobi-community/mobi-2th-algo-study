...
// 1. number 당 약수의 개수를 배열로 반환
// 1-2. number를 1...number로 나눈 나머지가 0인 것 중에서 중복을 제외하고 count
// 2. 약수의 개수가 3 초과 시 2 return
// 3. 총합을 return
...
// 각 기사단원의 약수 개수 구하는 함수
function countDivisors(n) {
  let count = 0;
  // 1부터 Math.sqrt(n)까지의 숫자로 나누어 약수를 찾기
